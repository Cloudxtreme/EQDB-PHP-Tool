...
function copy_item () {
  global $mysql;
   ...
   $mysql->query_no_result($query);
   // removing UNK038
   //source, UNK033, lorefile, UNK014, svcorruption, UNK038, UNK060, augslot1unk2, augslot2unk2, 
   // SELECT
   // UNK014, svcorruption, UNK038, UNK060, augslot1unk2, augslot2unk2, augslot3unk2, 
